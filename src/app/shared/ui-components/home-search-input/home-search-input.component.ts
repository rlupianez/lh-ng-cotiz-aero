...
@Component({
  selector: 'app-home-search-input',
  templateUrl: './home-search-input.component.html',
  styleUrls: ['./home-search-input.component.scss']
})
export class HomeSearchInputComponent implements OnInit {
  ...
  */
  ...
  get hideSearchTypeBtns(){
    return !this.isFocused && this.filterSelected === "";
  }
  ...
  suffixClicked(event, value){
    event.preventDefault();
    this.filterSelected = value;
    this.inputSuffixEvent.emit(value);
  }
